  ...
  return (
    ...
    <Container maxWidth="lg">
          <Box sx={{display:"flex",justifyContent:"center"}}>
                <Typography sx={{color:"white",fontWeight:"600",fontSize:"30px",fontFamily: 'Poppins, sans-serif',display:"flex",alignItems:"center"}}>Contact Us</Typography>
          </Box>
          <Box sx={{display:"flex",justifyContent:"center",mt:"20px"}}>
                <HouseIcon sx={{color:"#E3951B",fontSize:"22px"}}/>
                <Breadcrumbs aria-label="breadcrumb" >
                   <Link underline="hover" sx={{color:"white",fontWeight:"600"}} href="/"></Link>
                   <Typography sx={{ color: '#DDE4FF',fontFamily: 'Rubik, sans-serif'}}>Contact Us</Typography>
                </Breadcrumbs> 
          </Box>
    </Container>
  </Box>
